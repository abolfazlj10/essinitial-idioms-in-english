...
export default function Story () {
    ...
    return(
        <div className="h-full flex flex-col gap-5">
            ...
            <div className="grid grid-cols-[6fr_2fr] gap-10 h-full">
                ...
                <div className="border border-gray-400/10 rounded-xl relative overflow-hidden shadow-xl">
                    ...
                    <div className="bg-white/30 h-full w-full backdrop-blur-2xl z-30 relative py-7 px-5 flex flex-col gap-10">
                        <div>
                            ...
                            <div className="text-[30px] font-semibold text-center rounded-xl bg-white/20 border py-2">Elementry</div>
                        </div>
                        <div>
                            ...
                            <div className="text-[30px] font-semibold text-center rounded-xl bg-white/20 border py-2">Lesson 13</div>
                        </div>
                        <div>
