...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body>
        <div className="relative min-h-screen max-h-screen min-w-screen max-w-screen h-screen w-screen flex justify-center items-center py-22 max-tablet:py-12 max-mobile:py-0 z-10">
