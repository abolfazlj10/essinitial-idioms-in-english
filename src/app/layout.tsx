...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body>
        <div className="relative min-h-screen max-h-screen min-w-screen max-w-screen h-screen w-screen flex justify-center items-center py-22 max-tablet:py-12 z-10">
          ...
          <div className="h-full w-full max-h-[1200px] max-tablet:max-h-[1000px] max-w-[2000px] mx-60 max-[2000px]:mx-24 max-[1315px]:mx-16 max-tablet:mx-5 border-4 max-tablet:border-2 bg-[#fff] max-tablet:bg-[#fff]/50 max-tablet:backdrop-blur-2xl shadow-2xl rounded-2xl text-black z-20 ">
            {children}
          </div>
        </div>
      </body>
