...
const Appbar: React.FC<AppbarProps> = ({ onBackClick, title, iconSrc, rightButton }) => (
    <div className="flex items-center justify-between ">
      <button className="flex items-center gap-2 px-4 py-2 max-laptop:px-3 rounded-lg bg-white/90 hover:bg-primaryColor/10 shadow border border-gray-200 text-gray-700 max-laptop:text-sm max-tablet:text-[10px] font-semibold transition-all duration-150 cursor-pointer" onClick={onBackClick}>
