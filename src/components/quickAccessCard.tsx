    ...
    return (
      <div className="flex flex-col gap-3 border rounded-2xl pl-4 pr-14 py-6 bg-[#f9f9f9]/30 shadow-lg duration-150 hover:border-[#5c6bec] hover:-translate-y-1">
        ...
        <div className="space-y-3">
          ...
          <Link href="/story" className="select-none text-xs border text-primaryColor rounded-lg p-2 w-1/2 text-center shadow cursor-pointer hover:bg-primaryColor hover:text-white duration-100">Learn more {'=>'}</Link>
        </div>
      </div>
    );
}